...
test('Validate that user is able to create the workpod and publish it', async () => {
    ...
    await workpodPage.searchInModal.fill(workpodData.autodeployValidationWorkpod.users[5])
    await workpodPage.clickOnCheckBoxByText(workpodData.autodeployValidationWorkpod.users[5])
